  ...
  return (
    <>
      ...
      <div className="py-4 m-5 w-50 shadow bg-white text-dark border rounded container">
        ...
        ></ArrowCircleLeftIcon>
        <strong className="m-1" style={{ color: "#008080", paddingBottom:"1px" }}>
          {data.name}
        </strong>
        <div
          className="bg-light border rounded p-3 mb-4"
          style={{ height: "450px", overflow: "scroll", overflowX:"hidden" }}
        >
          {allMessages.map((msg, key) => {
            return data.name === msg.name ? (
              ...
              <div className="row justify-content-start">
                ...
                <div
                  className="d-flex flex-column m-2 p-1 shadow  border rounded w-auto"
                  style={{ backgroundColor: "#008080" }}
                >
                  <h4 className="m-1" style={{ color: "#ffffff" }}>
                    {msg.msg}
                  </h4>
                </div>
              </div>
